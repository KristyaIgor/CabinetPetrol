...
import edi.md.mydesign.remote.cardDetailInfo.CardItemAssortment;

/**
 * Created by Igor on 20.07.2020
 */

public class CardItemProductListAdapter extends RecyclerView.Adapter<CardItemProductListAdapter.ViewHolder> {

    List<CardItemAssortment> mData;
    private Context mContext;

    public CardItemProductListAdapter(Context context, List<CardItemAssortment> list){
        this.mData = list;
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        CardItemAssortment item = mData.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView name, limitDay, limitWeek, limitMont, additionalLimit, additionalLimitDate;
