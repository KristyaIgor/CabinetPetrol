...
import edi.md.mydesign.bottomsheet.EditCardLimitBottomSheetDialog;
import edi.md.mydesign.bottomsheet.FilterTransactionBottomSheetDialog;
import edi.md.mydesign.customindicator.MyPageChartIndicator;
import edi.md.mydesign.fragments.slidePage.FragmentCardLimitsInfo;
...
import edi.md.mydesign.remote.cardInfo.CardInfo;
...
public class CardDetailActivity extends AppCompatActivity {
    ...
    private static void reAuthClient(ClientRealm client) {
