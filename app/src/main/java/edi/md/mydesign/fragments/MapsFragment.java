...
//            googleMap.addMarker(new MarkerOptions().position(chisnau).title("Marker in Chisinau").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
//            googleMap.addMarker(new MarkerOptions().position(rompetrolIaloveni).title("Marker in Ialoveni").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
//            googleMap.addMarker(new MarkerOptions().position(rompetrolHincesti).title("Marker in Ialoveni").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
//            googleMap.addMarker(new MarkerOptions().position(romSac3).title("SAC-3").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
            googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(chisnau, 8));
