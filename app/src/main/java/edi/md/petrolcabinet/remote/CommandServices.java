...
import edi.md.petrolcabinet.remote.resetPassword.ConfirmResetPasswordBody;
...
public interface CommandServices {
    ...
    //Variant with RxJava
//    Observable<PressResponse> getPressRx (@Path("serviceName") String serviceName, @Query("ID") int id, @Query("Language") int identifier);
