...
public class FragmentBalanceCardInfo extends Fragment {
    ...
    public FragmentBalanceCardInfo() {
        // Required empty public constructor
    }

    public static FragmentBalanceCardInfo newInstance(String param1, double param2, String param3) {
        FragmentBalanceCardInfo fragment = new FragmentBalanceCardInfo();
