...
public class FragmentCardLimitsInfoMonth extends Fragment {
    ...
    private static FragmentCardLimitsInfoMonth sameInstanceFragment;

    public FragmentCardLimitsInfoMonth() {
        // Required empty public constructor
    }

    public static FragmentCardLimitsInfoMonth newInstance(int limit, int used, int remain, int limitType) {

        sameInstanceFragment = new FragmentCardLimitsInfoMonth();
